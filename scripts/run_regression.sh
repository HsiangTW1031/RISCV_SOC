...
run_one "timer" "$ROOT/blocks/timer/sim" timer timer_sim obj_dir_regr \
  -I"$ROOT/rtl/include" ../rtl/timer.v sim_main.cpp

run_one "watchdog" "$ROOT/blocks/watchdog/sim" watchdog watchdog_sim obj_dir_regr \
  -I"$ROOT/rtl/include" ../rtl/watchdog.v sim_main.cpp

run_one "uart" "$ROOT/blocks/uart/sim" uart uart_sim obj_dir_regr \
  -I"$ROOT/rtl/include" ../rtl/uart.v sim_main.cpp

run_one "sram" "$ROOT/blocks/sram/sim" sram sram_sim obj_dir_regr \
  -I"$ROOT/rtl/include" ../rtl/sram.v sim_main.cpp

run_one "boot_rom" "$ROOT/blocks/boot_rom/sim" boot_rom boot_rom_sim obj_dir_regr \
  -I"$ROOT/rtl/include" '-GHEXFILE="test.hex"' ../rtl/boot_rom.v sim_main.cpp

# ---- I2C / SPI (their own testtop + fake pins/reference model) ----
run_one "i2c" "$ROOT/blocks/i2c/sim" i2c_testtop i2c_sim obj_dir_regr \
  -I"$ROOT/rtl/include" -I../rtl ../rtl/i2c_master.v "$ROOT/tb/common/fake_i2c_slave.v" i2c_testtop.v sim_main.cpp

run_one "spi" "$ROOT/blocks/spi/sim" spi_testtop spi_sim obj_dir_regr \
...
run_one "jtag_tap" "$ROOT/blocks/jtag/sim" jtag_tap jtag_tap_sim obj_dir_tap_regr \
  -I"$ROOT/rtl/include" ../rtl/jtag_tap.v tap_sim_main.cpp

run_one "jtag_chain" "$ROOT/blocks/jtag/sim" jtag_chain_testtop jtag_chain_sim obj_dir_chain_regr \
...
run_one "aes_key_expand" "$ROOT/blocks/aes/sim" aes_key_expand keyexp_sim obj_dir_keyexp_regr \
  -I../rtl ../rtl/aes_key_expand.v key_expand_sim_main.cpp

run_one "aes_core" "$ROOT/blocks/aes/sim" aes_core core_sim obj_dir_core_regr \
  -I../rtl ../rtl/aes_key_expand.v ../rtl/aes_core.v core_sim_main.cpp

run_one "aes_chain" "$ROOT/blocks/aes/sim" aes_chain chain_sim obj_dir_chain_regr \
  -I../rtl ../rtl/aes_key_expand.v ../rtl/aes_core.v ../rtl/aes_chain.v chain_sim_main.cpp

run_one "aes_axi_wrapper" "$ROOT/blocks/aes/sim" aes aes_sim obj_dir_regr \
  -I"$ROOT/rtl/include" -I../rtl ../rtl/aes_key_expand.v ../rtl/aes_core.v ../rtl/aes_chain.v ../rtl/aes.v sim_main.cpp

run_one "aes_diff" "$ROOT/blocks/aes/sim" aes diff_sim obj_dir_diff_regr \
...
run_one "axi_lite_xbar" "$ROOT/blocks/axi_lite_xbar/sim" xbar_testtop xbar_sim obj_dir_regr \
...
run_one "dma_ram" "$ROOT/blocks/dma/sim" dma_ram dma_ram_sim obj_dir_ram_regr \
  -I"$ROOT/rtl/include" ../rtl/dma_ram.v dma_ram_sim_main.cpp

run_one "dma_engine" "$ROOT/blocks/dma/sim" dma_engine_testtop dma_engine_sim obj_dir_engine_regr \
...
run_one "soc_top" "$ROOT/blocks/soc_top/sim" soc_top soc_sim obj_dir_regr \
